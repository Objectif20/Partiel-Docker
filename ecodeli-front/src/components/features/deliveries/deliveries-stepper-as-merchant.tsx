...
import type { PackagesFormValues, PickUpEndFormValues, PriceChoiceBisFormValues } from "./types"
...
export function DeliveriesStepperAsMerchant() {
  const [formData, setFormData] = useState<{
    packages: PackagesFormValues | null
    pickupEnd: PickUpEndFormValues | null
    price : PriceChoiceBisFormValues | null
  }>({
    packages: null,
    pickupEnd: null,
    price : null,
...
const FormStepperComponent = ({ formData, setFormData }: FormStepperProps) => {
  ...
  const onSubmit = async (values: any) => {
    ...
    if (methods.isLast) {
      ...
      formDataToSend.append("shipment[deadline_date]", price?.deadline_date || "");
              ...
              {methods.switch({
                ...
                price: ({ Component }) => (
                  <Component
                    ...
                    pickupEndData={formData.pickupEnd}
                  />
