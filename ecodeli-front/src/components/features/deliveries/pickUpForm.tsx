...
export const PickupFormComponent = ({  }: { onFormSubmit: (data: PickUpFormValues) => void }) => {
  const { control, watch } = useFormContext<PickUpFormValues>();
  
  const departureHandling = watch("departure_handling");
