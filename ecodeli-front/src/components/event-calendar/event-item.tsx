...
function EventWrapper({
  ...
  return (
    <button
      className={cn(
        "focus-visible:border-ring focus-visible:ring-ring/50 flex w-full overflow-hidden px-1 text-left font-medium backdrop-blur-md transition outline-none select-none focus-visible:ring-[3px] data-dragging:cursor-grabbing data-dragging:shadow-lg data-past-event:line-through sm:px-2",
  ...
  if (view === "month") {
    return (
      <EventWrapper
        ...
        onClick={onClick}
        className={cn(
          "mt-[var(--event-gap)] items-center text-[10px] sm:text-xs",
          className
        )}
