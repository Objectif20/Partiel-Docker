...
const MinimalTiptapEditorReadOnly = React.forwardRef<HTMLDivElement, MinimalTiptapProps>(
  ({ value, onChange, className, editorContentClassName, ...props }, ref) => {
    const editor = useMinimalTiptapEditor({
      value,
      onUpdate: onChange,
...
const MinimalTiptapEditorTextOnly = React.forwardRef<HTMLDivElement, MinimalTiptapProps>(
  ({ value, onChange, className, editorContentClassName, ...props }, ref) => {
    const editor = useMinimalTiptapEditor({
      value,
      onUpdate: onChange,
...
MinimalTiptapEditorReadOnly.displayName = 'MinimalTiptapEditorReadOnly'
MinimalTiptapEditorTextOnly.displayName = 'MinimalTiptapEditorTextOnly'

export default MinimalTiptapEditor
export { MinimalTiptapEditorReadOnly, MinimalTiptapEditorTextOnly };